...
<tbody>
  <tr>
    ...
    <td>Gabriel Anthony Braithuaite Toledo:<br><br> TB1:se encargó de explicar el capítulo 5, donde abordó aspectos cruciales como la gestión de la configuración del software y las validaciones. Su enfoque claro facilitó la comprensión de temas técnicos entre todos.<br><br>Adrian Alonso Calle Huayanca:<br><br> TB1: Para este punto coordino con el equipo para en conjunto poder decidir un diseño de producto y estilo.<br><br>Hardie Alfonso Holguín Gamarra:<br><br> TB1: En esta entrega lidero al equipo , y brindo su puntuacion para todos los requerimientos de especificacion.<br><br>Mateo Italo Loechle Arias:<br><br>TB1: Comunico con su equipo todo el proceso de LeanUX , al igual que los antecedentes y problematica<br><br>David Bryan Rodriguez Santos:<br><br>TB1: Presento el capitulo 2 , donde tras una investigacion se halo los competidores , y se coordino para la distribucion de entrevistas.<br><br><br><br>Gabriel Anthony Braithuaite Toledo:<br><br> TP: Comunico su interes por mejorar el contenido del reporte en los puntos resaltados.<br><br>Adrian Alonso Calle Huayanca:<br><br> TP: Demostro su comunicacion al reportar posibles soluciones al punto 4 de el reporte.<br><br>Hardie Alfonso Holguín Gamarra:<br><br>TP: Lidero el proceso de development para la aplicacion principal , ideó los componentes principales de la aplicacion y coordino la mejora del reporte.<br><br>Mateo Italo Loechle Arias:<br><br>TP: Se analizo las posibles correcciones en el reporte y la posibilidad de agregar componentes utiles para el development principal.<br><br>David Bryan Rodriguez Santos:<br><br>TP: Presento las posibles correcciones extras a los otros puntos de el proyecto asimismo como el development de la aplicacion principal. <br><br>      </td>
    <td>Se lograron los objetivos establecidos<br>gracias a la constante comunicación y<br>organización de<br>nuestro equipo para la correcta elaboración e<br>implementación del presente </td>
  </tr>
  <tr>
    ...
    <td>Gabriel Anthony Braithuaite Toledo:<br><br> TB1: redactó el capítulo 5, entregando una documentación técnica y clara que facilitó la comprensión entre los miembros del equipo.<br><br>Adrian Alonso Calle Huayanca:<br><br> TB1:Proporcionó información escrita sobre el diseño del producto y la arquitectura de la información, lo que fue esencial para las siguientes etapas del proyecto. <br><br>Hardie Alfonso Holguín Gamarra:<br><br> TB1: Presentó una visión estructurada de los requisitos y escenarios futuros y ayudo en gran parte en todos los puntos del equipo.<br><br>Mateo Italo Loechle Arias:<br><br>TB1: Completó el capítulo 1, documentando de manera sistemática el perfil del startup y el proceso Lean UX. Tambien complemento con la eleccion de segmentos objetivos.<br><br>David Bryan Rodriguez Santos:<br><br>TB1: Completo todo el capitulo 2, realizo la investigacion de cada competidor y sus respectivas comparaciones , asimismo aporto con las entrevistas y el analisis de las mismas.<br><br><br><br><br>Gabriel Anthony Braithuaite Toledo:<br><br> TP: Se realizo la correcion del capitulo 5 , los nuevos spritns , user stories  y workitems de los user stories por sprint .<br><br>Adrian Alonso Calle Huayanca:<br><br>TP: Realizo las correciones en su area (punto 4) , de esta forma completandolo. <br><br>Hardie Alfonso Holguín Gamarra:<br><br>TP: Realizo , el mayor porcentaje de progreso con respecto a la primera version del proyecto Re'grill.<br><br>Mateo Italo Loechle Arias:<br><br>TP: Realizo las correciones en el punto numero 1 , LeanUX assumptions .Aporto en la posible implementacion de el componente dupe y table manager.<br><br>David Bryan Rodriguez Santos:<br><br>TP: <br>Realizo las correcciones de los puntos correspondientes , y realizo un early version de el componente dupe para el proyecto.</td>
    <td>Mediante el proceso , se logro completar los puntos necesarios en equipo. Cumpliendo asi con el criterio especifico. <br>En este caso demostrando de manera escrita que , cada uno aporto significativamente a el proceso de esta TB.</td>
  </tr>
</tbody></table>
...
| 3      |EP03               	 | Control y Reporte de Uso de Ingredientes  	             | *Como* administrador *Quiero* llevar un control detallado de la merma y generar reportes sobre el uso de ingredientes *Para* optimizar la gestión del inventario.                                                                                             | 2                        |
...
| 19     |US-09             	  | Landing page - Formulario de contacto                   | Como visitante de la landing page, quiero encontrar un formulario de contacto para poder comunicarme con el equipo de la aplicación.                                                                                                                         | 8                        |
...
| 25     |US-15             	  | Ingreso y confirmación de Reservas                      | Como administrador, quiero agregar las reservas de mesas para asegurar un servicio rápido y eficiente.                                                                                                                                                       | 3                        |
| 26     |US-16             	  | Generación de Facturas                                  | Como administrador, quiero generar facturas para los clientes para asegurar un servicio rápido y eficiente.                                                                                                                                                  | 3                        |
| 27     |US-17             	  | Reporte de Ventas                                       | Como administrador, quiero ver estadísticas sobre las ventas para tomar decisiones informadas sobre la gestión del restaurante.                                                                                                                              | 2                        |
| 28     |US-18             	  | Reporte de Caja                                         | Como administrador, quiero ver estadísticas sobre las transacciones de caja para asegurar una contabilidad clara.                                                                                                                                            | 2                        |
| 29     |US-19             	  | Acceso a cantidad de Uso de Ingredientes                | Como administrador, quiero ver estadísticas sobre el uso de ingredientes para ajustar los pedidos y optimizar la producción.                                                                                                                                 | 2                        |
| 30     |US-20             	  | Reporte de Uso de Ingredientes                          | Como administrador, quiero ver estadísticas sobre el uso de ingredientes para ajustar los pedidos y optimizar la producción.                                                                                                                                 | 2                        |
| 31     |US-21                | Registrar nuevo proveedor                               | Como proveedor, quiero registrar mis datos para mantener un registro actualizado con el restaurante.                                                                                                                                                          | 5                        |
| 32     |US-22                | Evaluar proveedor                                       | Como proveedor, quiero ser evaluado por el restaurante para asegurar la calidad de mis productos.                                                                                                                                                             | 3                        |
| 33     |US-23                | Actualizar datos del proveedor                          | Como proveedor, quiero actualizar mis datos para mantener la información actualizada con el restaurante.                                                                                                                                                      | 3                        |
| 34     |US-24                | Ver resultados de evaluación                            | Como proveedor, quiero ver los resultados de mi evaluación para conocer mi desempeño.                                                                                                                                                                                                          | 5                        |
| 35     |US-25                | Solicitar información sobre productos                   | Como proveedor, quiero solicitar información sobre los productos del restaurante para evaluar posibles colaboraciones.                                                                                                                                        | 5                        |
...
- Notificación a la cocina y proveedores en caso de falta de ingredientes.</p>
3.-Cocina recibe el pedido

- Información detallada y visual del platillo (ingredientes, tiempos de cocción, cantidad solicitada).</p>
- Monitoreo en tiempo real del estado del pedido.</p>
